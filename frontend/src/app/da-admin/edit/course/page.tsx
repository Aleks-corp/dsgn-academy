...
function EditCourseLinkPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-xl font-semibold">Редагування курсу</p>
      <label className="text-sm font-semibold text-muted">
        <p className="mb-2">
          Введіть ID для редагування <br /> або знайдіть потрібний курс і
...
export default withAdminGuard(EditCourseLinkPage);
