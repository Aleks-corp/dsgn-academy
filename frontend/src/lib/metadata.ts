...
export const metadata: Metadata = {
  metadataBase: new URL("https://dsgn-academy-ua.onrender.com"),
  ...
  openGraph: {
    ...
    url: "https://dsgn-academy-ua.onrender.com",
    siteName: "Dsgn Academy",
    images: [
      {
        url: "https://dsgn-academy-ua.onrender.com/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://dsgn-academy-ua.onrender.com/og-image.png"],
  },
  robots: {
    index: true,
    follow: true,
